...
app = FastAPI(
    ...
    version="0.4.1", # Versão atualizada
...
# --- Endpoint de Login/Token (PÚBLICO) ---
...
# --- NOVO ENDPOINT: Testar Token e Ver Informações ---
# Em app.py
...
# Incluir todos os routers na aplicação principal
